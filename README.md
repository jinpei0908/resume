...
BEエンジニアとしてSpring Boot, MySQLを用いたWeb API開発やSpring Batchを用いたバッチ開発を行ってきました。システム設計やDB設計、DBのチューニングも経験があります。
...
Bash, Pythonは作業の自動化や推論API開発で使用しました。業務としては少ないですが日常的に使用してます。
...
学生時代から慣れ親しんでいることもあり、TypeScript/JavaScript, Goは一部プロジェクトで使用しました。
